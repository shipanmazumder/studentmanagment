<?php
	...
	if(isset($_FILES['image']))
    {
		...
		$query=mysql_query("SELECT * FROM student,teacher,admin WHERE  (class='$class' AND roll='$roll' AND section='$section') OR semail='$email' OR temail='$email' AND aemail='$eamil' ");
		 ...
		 {?>
            ...
            <?php
				...
				if($insert=mysql_query("INSERT INTO student(name,section,roll,birthday,gender,address,class,semail,mobile,password,picture,lavel) VALUE('$name','$section','$roll','$birthday','$gender','$address','$class','$email','$mobile','$pass','$file_name',3)")){
  ...
  <body>
  	...
  	<?php require_once("rightsidebar2.php"); ?>
        <div class="left_sidebar">
            ...
            <div class="content2">
            	<span class="t_d"><span class="glyphicon glyphicon-tasks"></span> Manage Students</span>
                	<div class="a_student">
                    	<form class="form-inline" method="POST" enctype="multipart/form-data">
                            <table  class="table table-bordered">
                            <thead>
                                <tr>
                                    <th><span class="glyphicon glyphicon-plus-sign"></span> Add Students</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td align="center"><span style=" margin-left:12px;">Roll</span> <input type="text" id="form" name="roll" class="form-control" required /></td>
                                </tr>
                                <tr>
                                    <td align="center"><span style=" margin-left:-12px;">Birthday</span> <input type="date" id="form" name="birthday" class="form-control" required /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                	<td align="center"><button style=" margin-left:-150px; color:#FFFFFF; background-color:#21A9E1; " type="submit" class=" btn btn-default" name="submit">Add Student</button></td>
                                </tr>
                            </tbody>
                        </table>
                     </form>
