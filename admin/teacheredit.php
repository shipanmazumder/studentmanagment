<?php
	...
	if(isset($_FILES['image']))
    {
        ...
        if($update=mysql_query("Update teacher set picture='$file_name' WHERE teacher_id='$teacher_id' ")){
	...
	if(isset($_POST['password'])){
		...
		$res=mysql_query("SELECT * FROM teacher WHERE teacher_id='$teacher_id'");
		...
		if($oldpassword==$rows['password']){
			...
			{?>
				...
				if($update=mysql_query("Update teacher set password='$newpassword' WHERE teacher_id='$teacher_id' ")){
					header("location:teacher.php");
				}
        	}
		}
            	...
            	<span class="t_d"><span class="glyphicon glyphicon-tasks"></span> Manage Teacher</span>
                	<div class="a_student">
                    	<form class="form-inline" method="POST" >
                            ...
                            <thead>
                                <tr>
                                    <th><span class="glyphicon glyphicon-plus-sign"></span> Edit Teacher</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
