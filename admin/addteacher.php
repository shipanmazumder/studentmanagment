		...
		$query=mysql_query("SELECT * FROM teacher,admin,student WHERE  temail='$email' OR aemail='$email' OR semail='$email'  ");
		 ...
		 {?>
            ...
            <?php
				...
				if($insert=mysql_query("INSERT INTO teacher(name,birthday,gender,address,temail,mobile,password,picture,lavel) VALUE('$name','$birthday','$gender','$address','$email','$mobile','$pass','$file_name',2)")){
            	...
            	<span class="t_d"><span class="glyphicon glyphicon-tasks"></span> Manage Teacher</span>
                	<div class="a_student">
                    	<form class="form-inline" method="POST" enctype="multipart/form-data">
                            ...
                            <thead>
                                <tr>
                                    <th><span class="glyphicon glyphicon-plus-sign"></span> Add New Teacher</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                	<td align="center"><button style=" margin-left:-150px; color:#FFFFFF; background-color:#21A9E1; " type="submit" class=" btn btn-default" name="submit">Add Teacher</button></td>
                                </tr>
                            </tbody>
                        </table>
                     </form>
