<?php
	...
	if(isset($_FILES['image']))
    {
        ...
        if($update=mysql_query("Update student set picture='$file_name' WHERE student_id='$student_id' ")){
	...
	if(isset($_POST['submit'])){
		...
		if($update=mysql_query("Update student set  name='$name',class='$class',roll='$roll',section='$section',address='$address',birthday='$birthday',gender='$gender', mobile='$mobile',semail='$email' WHERE student_id='$student_id' ")){
            header("location:student.php");
        }
	}
	if(isset($_POST['password'])){
		...
		if($oldpassword==$rows['password']){
			...
			{?>
				...
				if($update=mysql_query("Update student set password='$newpassword' WHERE student_id='$student_id' ")){
					header("location:student.php");
				}
        	}
		}
  ...
  <body>
  	...
  	<?php require_once("rightsidebar3.php"); ?>
        <div class="left_sidebar">
            ...
            <div class="content3">
            	<span class="t_d"><span class="glyphicon glyphicon-tasks"> Manage Student</span></span>
                	<div class="a_student">
                    	<form class="form-inline" method="POST" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="center">Class <input type="text" name="class" id="form" value="<?php echo $row['class']; ?>"  class="form-control" required /></td>
                                </tr>
                                <tr>
                                    <td align="center"><span style=" margin-left:-10px;">Section</span> <input type="text" name="section" id="form" value="<?php echo $row['section']; ?>"  class="form-control" required /></td>
                                </tr>
                                <tr>
                                    <td align="center"><span style=" margin-left:20px;">Roll</span><input type="text" name="roll" id="form" value="<?php echo $row['roll']; ?>"  class="form-control" required /></td>
                                </tr>
                                <tr>
